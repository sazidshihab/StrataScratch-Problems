create database `2102_flags_per_video`;
use `2102_flags_per_video`;
...
insert into user_flags values ('Richard', 'Hasson', 'y6120QOlsfU', '0cazx3'),
...
select video_id,
count( distinct concat(trim(coalesce(user_firstname,'n/a')),trim(coalesce(user_lastname,'n/a')))) as num_unique_users
from user_flags
