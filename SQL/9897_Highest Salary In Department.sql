create database `9897. Highest Salary In Department`;
use `9897. Highest Salary In Department`;
...
INSERT INTO employee (
    id, first_name, last_name, age, sex, employee_title, department, 
    salary, target, bonus, email, city, address, manager_id
) VALUES
...
first_name,
salary,
dense_rank()over(partition by department order by salary desc) as rnkk
from employee)
select department,
first_name,salary from cte 
where rnkk=1
;